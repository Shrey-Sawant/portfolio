  ...
  return (
    <div className="bg-[#e7e7e7] text-[#111] min-h-screen relative overflow-x-hidden">
      <main className="max-w-screen mx-auto px-20 py-12 pb-20">
        ...
        <div
          className={`grid gap-12 items-center mt-8 mb-18 ${image ? "grid-cols-2" : "grid-cols-1"} max-[900px]:grid-cols-1`}
        >
          <div>
            ...
            {liveUrl && (
              <a
                ...
                className="inline-flex items-center gap-2 mt-6 px-5 py-2.5 bg-[#111] text-white text-sm font-semibold rounded-full hover:bg-gray-800 transition-colors"
              >
                Visit Website →
              </a>
            )}
          ...
          <div className="mb-18">
            ...
            <div className="grid grid-cols-3 max-[900px]:grid-cols-2 max-[600px]:grid-cols-1 gap-5">
              {technology.items.map((item) => (
                <div
                  key={item.name}
                  className="border border-gray-300 rounded-2xl p-8 bg-[#e7e7e7] hover:border-green-500 hover:bg-green-50 transition-colors"
                >
                  <p className="text-lg font-bold text-[#111] mb-3 leading-snug">
                    {item.name}
                  </p>
        ...
        {next && (
          <div className="flex justify-end mt-10">
            <button
              ...
              className="block border border-gray-300 rounded-xl px-7 py-6 min-w-[260px] text-right bg-[#e7e7e7] hover:border-green-500 hover:bg-green-50 transition-colors cursor-pointer"
            >
